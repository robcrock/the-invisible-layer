    ...
    beats: [
      {
        ...
        body: '120 points, one marked date. Press start and read the value at the tick. The timer runs until you catch it.',
        demoStage: 'hunt',
      },
      {
        id: 'cold-open-2',
        title: "The chart isn't broken — it's honest",
        body: 'A small value is a short bar. A trend is a 2px line. The data set your target sizes, and the clock is what that costs.',
        demoStage: 'honest',
      },
      {
        id: 'cold-open-3',
        ...
        body: 'Data integrity wants honest marks. Usability wants generous targets. The invisible layer is how a chart gets both. By the lines phase, we fix this exact chart.',
        demoStage: 'reveal',
      },
    ],
  },
    ...
    beats: [
      {
        ...
        body: "The cold open's chart is back, same 120 points. No rectangle to draw this time — just a thin path and a steady hand. Keep the tooltip alive.",
        demoStage: 'trace',
      },
      {
        id: 'lines-2',
    ...
    beats: [
      {
        ...
        body: 'Ninety points, three-pixel dots. Find and hover the ringed one. Miss and nothing happens. Worse: land dead-on and the wrong name pops up — two points overlap, and DOM order decides who wins.',
        demoStage: 'naive',
      },
      {
        id: 'scatter-2',
        ...
        body: "Five ringed dots, in order, against the clock. Every empty click is a dead-space miss; every wrong name, a mis-trigger. About 1.5% of this plot is alive — you're aiming at confetti.",
        demoStage: 'game-1',
      },
      {
        id: 'scatter-3',
  ...
  },
  {
    ...
    beats: [
      ...
      },
      {
        ...
        body: "How much of my chart responds, versus how much should? Toggle the targets here and nothing new appears — this chart scores 100%. Now run that test on a thin pie slice, a stacked-area band, a sparkline. You can answer it, and you can put a clock on the difference.",
        demoStage: 'coverage',
      },
    ],
  },
